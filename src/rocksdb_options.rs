...
pub struct IngestExternalFileOptions {
    pub inner: *mut rocksdb_ffi::IngestExternalFileOptions,
}
...
impl IngestExternalFileOptions {
    ...
    pub fn snapshot_consistent(self, whether_consistent: bool) -> IngestExternalFileOptions {
        unsafe {
            rocksdb_ffi::rocksdb_ingestexternalfileoptions_set_snapshot_consistency(
    ...
    pub fn allow_global_seqno(self, whether_allow: bool) -> IngestExternalFileOptions {
        unsafe {
            rocksdb_ffi::rocksdb_ingestexternalfileoptions_set_allow_global_seqno(self.inner,
                                                                                  whether_allow);
        }
        self
    }
    ...
    pub fn allow_blocking_flush(self, whether_allow: bool) -> IngestExternalFileOptions {
        unsafe {
            rocksdb_ffi::rocksdb_ingestexternalfileoptions_set_allow_blocking_flush(self.inner,
                                                                                    whether_allow);
        }
        self
    }
    ...
    pub fn move_files(self, whether_move: bool) -> IngestExternalFileOptions {
        unsafe {
            rocksdb_ffi::rocksdb_ingestexternalfileoptions_set_move_files(self.inner, whether_move);
        }
        self
    }
}
...
pub struct EnvOptions {
    pub inner: *mut rocksdb_ffi::EnvOptions,
}

impl EnvOptions {
    pub fn new() -> EnvOptions {
        unsafe { EnvOptions { inner: rocksdb_ffi::rocksdb_envoptions_create() } }
    }
}
